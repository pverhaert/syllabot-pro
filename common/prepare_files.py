...
class PrepareFiles:
    ...
    def make_files(self):
        ...
        metrics = [
            ...
            f"- 📚️ **Chapters/topics that must be included:** <span style='color: red'>{self.inputs.chapters_that_must_be_included}</span>\n",
            f"- 🌟 **Special Needs:** <span style='color: red'>{self.inputs.special_needs}</span>\n",
