...
REM Check if models.py file exists, if not, copy models.example.py to models.py
if not exist "models.py" (
    echo Copying models.example.py to models.py...
    copy "models.example.py" "models.py"
) else (
    echo models.py file already exists. Skipping copy.
)
